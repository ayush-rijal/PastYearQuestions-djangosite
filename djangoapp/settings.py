...
# example--->AWS_SECRET_ACCESS_KEY = env('AWS_SECRET_ACCESS_KEY')

AWS_ACCESS_KEY_ID = 'AKIA5WLTTKTPAYXT4VNM'
AWS_SECRET_ACCESS_KEY = 'G+tmVt5VDdKx3NXrh6qtLup4ZqNfUp230zwPI7AT'
AWS_STORAGE_BUCKET_NAME = 'pyqbucket'
# AWS_S3_REGION_NAME = 'us-east-2' 
